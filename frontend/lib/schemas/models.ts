...
export const RoomIdSchema = z.uuid({ version: "v7" }).transform((val) => val as RoomId);
export const UserIdSchema = z.uuid({ version: "v7" }).transform((val) => val as UserId);
...
export const RoomSchema = z.object({
  ...
  is_active: z.boolean(),
  created_at: z.iso.datetime(), // Rustの DateTime<Utc> は ISO8601 文字列で来る
